...
export default function FutureSelf() {
  ...
  const [showDialog, setShowDialog] = useState(false); // Renamed from isWriting to showDialog
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      setNewLetter({ title: '', content: '', unlock_date: '' }); // Reset form fields
    } catch (error) {
  ...
  // The previous 'if (isWriting)' block is now integrated into the Dialog component below.
    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          ...
          <div className="space-y-4"> {/* Use space-y for vertical gap between cards */}
